...
// ARIS: modified return value.:
//   Negative still means unrecoverable errors.
//   0 - means no errors
//   positive - means some errors were recovered (don't know how many!
ssize_t correct_reed_solomon_decode(correct_reed_solomon *rs, const uint8_t *encoded, size_t encoded_length,
    ...
    if (all_zero) {
        ...
        return 0;  // Aris - modified to show no errors.
    }
