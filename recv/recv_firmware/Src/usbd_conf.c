...
// AE: hpcd_USB_OTG_FS must not be in DTCM. It contains the buffer for the setup packet which is acessed by DMA.
/* USER CODE END PV */

CFG_USB_MEM_SECTION PCD_HandleTypeDef hpcd_USB_OTG_FS;
...
/**
  ...
  * @retval None
  */
CFG_USB_MEM_SECTION uint32_t mem[(sizeof(USBD_CDC_HandleTypeDef)/4)+1];/* On 32-bit boundary */
